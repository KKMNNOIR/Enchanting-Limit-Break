...
execute store result score @s[tag=ToolEnch] SoulSpeed run data get entity @s Item.tag.Enchantments[{id:"minecraft:soul_speed"}].lvl
...
execute as @e[nbt={Item:{id:"minecraft:enchanted_book"}}] if entity @e[tag=MiscEnch,distance=..1] store result score @s[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:soul_speed"}]}}}] SoulSpeed run data get entity @s Item.tag.StoredEnchantments[{id:"minecraft:silk_touch"}].lvl
