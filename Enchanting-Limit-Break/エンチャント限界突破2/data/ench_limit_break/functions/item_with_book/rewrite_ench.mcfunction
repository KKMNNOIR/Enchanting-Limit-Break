...
execute if data entity @s[tag=!Enchanted] Item.tag.Enchantments[{id:"minecraft:soul_speed"}] if score @s SoulSpeed matches ..10 run tag @s add Enchanted
...
execute as @s[tag=ToolEnch] if score @s Efficiency matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:efficiency"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=ArmorEnch] if score @s FeatherFalling matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:feather_falling"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=ArmorEnch] if score @s FireProtection matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:fire_protection"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=ToolEnch] if score @s Fortune matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:fortune"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=TridentEnch] if score @s Impaling matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:impaling"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=SwordEnch] if score @s Knockback matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:knockback"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=SwordEnch] if score @s Looting matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:looting"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=FishingRodEnch] if score @s LuckOfTheSea matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:luck_of_the_sea"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=FishingRodEnch] if score @s Lure matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:lure"}]}}},distance=0.001..1] run data modify entity @s Item.tag.Enchantments append from entity @e[nbt={Item:{tag:{StoredEnchantments:[{}]}}},limit=1,sort=nearest,distance=0.0001..1] Item.tag.StoredEnchantments[{id:"minecraft:lure"}]
execute as @s[tag=FishingRodEnch] if score @s Lure matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:lure"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=CrossbowEnch] if score @s Piercing matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:piercing"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=BowEnch] if score @s Power matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:power"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=ArmorEnch] if score @s P.Protection matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:projectile_protection"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=ArmorEnch] if score @s Protection matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:protection"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=BowEnch] if score @s Punch matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:punch"}]}}},distance=0.001..1] run tag @s add Enchanted
...
execute as @s[tag=BootsEnch] if score @s DepthStrider matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:depth_strider"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=SwordEnch] if score @s FireAspect matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:fire_aspect"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=BootsEnch] if score @s FrostWalker matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:frost_walker"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=TridentEnch] if score @s Loyalty matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:loyalty"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=TridentEnch] if score @s Riptide matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:riptide"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=SwordEnch,tag=!AxeEnch] if score @s Sweeping matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:sweeping"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=HelmetEnch] if score @s AquaAffinity matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:aqua_affinity"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=TridentEnch] if score @s Channeling matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:channeling"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=BowEnch] if score @s Flame matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:flame"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=CrossbowEnch] if score @s Flame matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:flame"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=BowEnch] if score @s Infinity matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:infinity"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=CrossbowEnch] if score @s Infinity matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:infinity"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=MiscEnch] if score @s Mending matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:mending"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=CrossbowEnch] if score @s Multishot matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:multishot"}]}}},distance=0.001..1] run tag @s add Enchanted
execute as @s[tag=ToolEnch] if score @s SilkTouch matches 0 if entity @e[nbt={Item:{tag:{StoredEnchantments:[{id:"minecraft:silk_touch"}]}}},distance=0.001..1] run tag @s add Enchanted
